package com.experimental.login;
...
public class LoginController implements Initializable {
    ...
    private void authenticate(Event event) throws Exception {
        if (validateInput()) {
            ...
            String accessToken = passwordField.getText().trim();


            //BeyondAPI.initialize("beyondshop.cloud", "1754", username, accessToken);
            //System.out.println(BeyondAPI.getInstance().getProductNames().size());
